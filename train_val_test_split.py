...
parser.add_argument('--train_pct', help='Ratio of images to go to train folder; \
                    ...
                    default=.8)
parser.add_argument('--val_pct', help='Ratio of images to go to validation folder; \
                    the rest go to test folder (example: ".1")',
                    default=.1)
parser.add_argument('--test_pct', help='Ratio of images to go to test folder; \
                    the rest go to train and validation folders (example: ".1")',
                    default=.1)
